        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="account-login-inner">
                    <form action="index.php?act=quenmk" method="post" enctype="multipart/form-data" class="ltn__form-box contact-form-box">
                        <input type="email" name="email" placeholder="gmail">
                        <input type="text" name="user" placeholder="Tên Đăng Nhập">

                        <div class="btn-wrapper ">
                            <input type="submit" name="guiemail" value="Lấy Lại Mật Khẩu" class="type theme-btn-1 btn reverse-color btn-block" >
